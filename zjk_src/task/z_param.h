...
typedef enum{   sensor_idle, dist_continue_ack_cmd, dist_once_ack_cmd, dist_stop_ack_cmd,
...
typedef enum  { dist_base=0,dist_continue_ack, dist_once_ack, dist_stop_ack,
